...
#trait<- args[1]
#trait
setwd<- "/nobackup/sbcs/lyul1/IBD/metal_update/withoutUKB/gc_0.01/GC_Final/Plots/QQplot"
...
plots<- function (trait) {
    inputfilename <- paste0("/nobackup/sbcs/lyul1/IBD/metal_update/withoutUKB/gc_0.01/GC_Final/", trait, "_META1.TBL")
