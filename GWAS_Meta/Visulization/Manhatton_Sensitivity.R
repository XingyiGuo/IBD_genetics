...
setwd<- "/nobackup/sbcs/lyul1/IBD/metal_update/withoutUKB/gc_0.01/GC_Final/Plots/Manhattan"

# lead novel variants
alltraits<- read.csv("/nobackup/sbcs/lyul1/IBD/metal_update/withoutUKB/gc_0.01/select/lead.var.for.plots.csv", header=T)
...
gwas.ss<- fread(paste0("/nobackup/sbcs/lyul1/IBD/metal_update/withoutUKB/gc_0.01/GC_Final/processed/", inputfilename), fill = T)   #%>% subset(CHR %in% 1:22)
